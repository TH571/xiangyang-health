...
const teamMembers: TeamMember[] = [
  {
    ...
    name: '孙培龙',
    role: '',
    bio: '现任浙工大生态工业创新研究院院长、中国轻工业食品大分子资源加工技术重点实验室主任，任职于食品科学与工程学院；曾任浙江工业大学生物与环境工程学院、海洋学院和食品科学与工程学院党委书记，是浙江省首批重点创新团队 —— 食用菌行业创新团队带头人，浙江营养学会监事长。擅长领域：从事大分子物质的分离纯化、性质、功能及构效关系的研究，重点进行动植物功能性提取物及其在保健食品中的应用研究。'
  },
  {
    id: '2',
    name: '张华',
      ...
      <section className="relative py-12 md:py-20 text-white bg-gradient-to-r from-purple-600 to-pink-600 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <p className="text-lg text-white/90 max-w-2xl">
            向阳健康是浙江工业大学大健康校友联盟的官方网站，我们的使命是守护每一位浙工大人的健康，让健康成为生活的习惯。域名 www.xyjk.ren 为"向阳健康人"的拼音缩写
          </p>
        </div>
      </section>
